...
const menuArray = [
  ...
  },
  {
    title: "분양안내",
    subMenu: [
      { subTitle: "공급안내", subUrl: "/SalesInfo/SubscriptionGuide" },
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "84D", subUrl: "/Interior/84A" },
    ],
  },
];
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu(!isMobileMenu)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#2a1e4f" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#2a1e4f" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
