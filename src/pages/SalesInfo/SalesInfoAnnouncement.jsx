  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신영지웰 평택화양 - 모집공고안내</title>
        <meta
          name="description"
          content="신영지웰 평택화양의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요.
...
"
        ...
        <link
          rel="canonical"
          href="https://delidilly.co.kr/SalesInfo/announcement"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="신영지웰 평택화양 - 모집공고안내"
        />
        <meta
...
"
        ...
        <meta
          property="og:url"
          content="https://delidilly.co.kr/SalesInfo/announcement"
        />
          ...
          {`
                                        {
                                            ...
                                            "@type": "WebPage",
                                            "name": "신영지웰 평택화양 - 모집공고안내",
                                            "description": "신영지웰 평택화양의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요.

",
                                            "url": "https://delidilly.co.kr/SalesInfo/announcement"
                                        }
                                        `}
        </script>
      </Helmet>
