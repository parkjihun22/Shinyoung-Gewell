...
<Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신영지웰 평택화양 - 분양일정</title>
        <meta
          name="description"
          content="신영지웰 평택화양의 최신 분양일정을 확인하고, 분양 일정 및 세부 사항을 이 페이지에서 자세히 확인하세요. 놓치지 마세요!
"
        />
        <meta
          name="keywords"
          content="신영지웰 평택화양, 평택 화양 신영지웰, 신영지웰 평택화양모델하우스"
        />
        <link
          rel="canonical"
...
",
            ...
            <h1 className={styles.screenReaderOnly}>신영지웰 평택화양 - 분양일정</h1>
            <p className={styles.screenReaderOnly}>
			신영지웰 평택화양의 분양 일정은 중요한 날짜들을 안내하는 핵심 정보입니다.
            </p>
            ...
            <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="신영지웰 평택화양 분양일정안내-image1" />
