...
<Helmet>
		...
		{/* SEO 최적화를 위한 메타 태그 */}
		<title>신영지웰 평택화양 - 당첨자 서류안내</title>
		<meta
		  name="description"
		  content="신영지웰 평택화양 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
"
		/>
		<meta
		  name="keywords"
		  content="신영지웰 평택화양, 평택화양 신영지웰, 신영지웰 평택화양 모델하우스"
		/>
		<link
		  rel="canonical"
...
"
		...
		<meta
		  property="og:url"
		  content="https://delidilly.co.kr/BusinessGuide/documents"
		/>
		  ...
		  {`
										{
											...
											"@type": "WebPage",
											"name": "신영지웰 평택화양 - 당첨자 서류안내",
											"description": "신영지웰 평택화양 선착순계약을 위한 필수 서류 목록과 준비 절차를 안내합니다. 간단하고 명확한 정보로 청약 당첨 후 필요한 준비를 돕고, 서류 제출에 문제가 없도록 상세한 가이드를 제공합니다
",
											"url": "https://delidilly.co.kr/BusinessGuide/documents"
										}
										`}
		</script>
	  </Helmet>  
            ...
            <h1 className={styles.screenReaderOnly}>신영지웰 평택화양 - 계약서류안내</h1>
			...
			<div className={styles.textBox}>
				<div>화양신도시의 눈부신 가치 위에</div>
				<div>신영지웰 평택화양의 새로운 자부심으로 찾아옵니다.</div>
			</div>

			{/* 이미지에 isImageVisible 상태 적용 */}
			<img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="신영지웰 평택화양 계약서류안내-image1" />
