...
const section3Contents = [
  {
    ...
    title: "PREMIUM 01",
    text1: `999세대 중심상업지구 바로 옆`,
    text2: `평택 화양지구를 대표할<br />
			      다시는 없을 프리미엄 아파트`,
  ...
  return (
    <>
          ...
          {`
      {
        ...
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "경기도 평택시 화양지구",
          "addressLocality": "평택 화양지구",
          "addressRegion": "경기도",
          "postalCode": "우편번호"
        }
      }
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.mainImageTextBox}>
              <div className={styles.mainImageTextSub}>
                ...
                999세대{" "}
                <span className={styles.greyText}> 대단지 프리미엄</span> |
                계약금 0원으로 내집마련기회{" "}
                <span className={styles.greyText}>착한조건</span>
              </div>
              <div className={styles.mainImageTitleBox}>
                <div className={styles.mainImageText}>
                  계약금 없이 입주까지 최초이자, 마지막 조건
                </div>
                <div className={styles.mainImageLine}></div>
                <div className={styles.mainImageText}>평택 화양 신영지웰</div>
              </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 999세대 대단지 프리미엄 <br />- 
                 화양신도시 중심상업지구 바로 옆 단지 <br />
                  - 지역 내 주요 간선도로 및 교통망 개선을 통해 주요지역 연결
                  광역교통망의 중심
                  <br />- 모두를 누리는 신영지웰 평택화양
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="신영지웰 평택화양 브랜드소개-image4"
                />
                <div className={styles.text1}>신영지웰 평택화양</div>
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="신영지웰 평택화양 오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="신영지웰 평택화양 mobilemain-image1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
              <div className={styles.mainImageTextSub1}>
                중심상업지구 바로 옆
                <br />
                <span className={styles.greyText1}>입지 프리미엄</span>
                <br />
                999세대
                <br />
                <span className={styles.greyText1}>대단지 프리미엄</span>
                <br />
                계약금 0원으로 내집마련기회
                <br />
              ...
              <div className={styles.mainImageTitleBox1}>
                <div className={styles.mainImageText1}>신영지웰 평택화양</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.container7}>
            ...
            <img
              src={section8Img3}
              alt="신영지웰 평택화양 mobile입지안내-image1"
            />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 신영지웰 평택화양에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="신영지웰 평택화양 mobile조감도-image1"
            />
          </div>
          ...
          <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="신영지웰 평택화양 브랜드소개 mobile-image5"
              />
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="신영지웰 평택화양 오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
