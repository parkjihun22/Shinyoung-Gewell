  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신영지웰 평택화양 - 평면안내</title>
        <meta
          name="description"
          content="신영지웰 평택화양의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.
"
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://delidilly.co.kr/FloorPlan/59A"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="신영지웰 평택화양 - 평면안내"
        />
        <meta
...
"
        ...
        <meta
          property="og:url"
          content="https://delidilly.co.kr/FloorPlan/59A"
        />
          ...
          {`
										{
											...
											"@type": "WebPage",
											"name": "신영지웰 평택화양 - 평면안내",
											"description": "신영지웰 평택화양의 평면도를 통해 세대별 구조와 공간 활용도를 확인하세요. 실용적이고 혁신적인 설계를 기반으로 한 다양한 평면 구성이 여러분의 생활을 더 편리하게 만듭니다.
",
											"url": "https://delidilly.co.kr/FloorPlan/59A"
										}
										`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        59타입의평면 안내 페이지는 신영지웰 평택화양의 각 아파트
