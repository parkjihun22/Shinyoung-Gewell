  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>신영지웰 평택화양 - 커뮤니티</title>
        <meta
          name="description"
          content="신영지웰 평택화양의 커뮤니티 시설을 소개합니다. 피트니스 센터, 독서실, 카페 등 다양한 편의시설이 마련되어 있어 입주민의 생활 품격을 높이고, 편리함을 제공합니다.
"
        />
        <meta
          name="keywords"
...
",
      ...
      <p className={styles.screenReaderOnly}>
        신영지웰 평택화양의 커뮤니티 페이지에서는 단지 내 다양한
